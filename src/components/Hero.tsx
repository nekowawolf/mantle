...
export default function Hero({ isActive }: HeroProps) {
  ...
  return (
    <>
      ...
      {/* HERO CONTENT */}
      <section className="h-screen w-full relative z-10 px-6 md:px-16">

        {/* LEFT TOP TEXT */}
        <div className="absolute top-32 md:top-24 left-6 md:left-16 max-w-3xl">
          
          {/* MANTLE BIG */}
          <h1 className="text-[70px] md:text-[120px] lg:text-[150px] font-bold leading-[0.85] tracking-tight text-white">
            MANTLE
          </h1>

          {/* NETWORK SMALL UNDER IT */}
          <h2 className="text-xl md:text-3xl lg:text-4xl font-light text-gray-300 mt-1 ml-1 md:ml-2">
            Network
          </h2>
        ...
        {/* RIGHT BOTTOM TEXT */}
        <div className="absolute bottom-36 right-6 md:right-16 max-w-xs md:max-w-md text-right">
        ...
        <div className="absolute bottom-16 md:bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <p className="text-[10px] md:text-sm tracking-[0.3em] opacity-60 whitespace-nowrap">
            SCROLL TO EXPLORE
          </p>
        </div>
