...
const GOVERNANCE_TEXT_START_DESKTOP = 22600;
const GOVERNANCE_TEXT_START_MOBILE = 27700;
...
export default function Governance() {
  ...
  const containerOpacityDesktop = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_DESKTOP + 1700, GOVERNANCE_TEXT_START_DESKTOP + 2300],
    [1, 0]
  );

  const containerOpacityMobile = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_MOBILE + 1700, GOVERNANCE_TEXT_START_MOBILE + 2300],
    [1, 0]
  );
  ...
  const dCard1Op = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_DESKTOP + 2400, GOVERNANCE_TEXT_START_DESKTOP + 2800, GOVERNANCE_TEXT_START_DESKTOP + 4800, GOVERNANCE_TEXT_START_DESKTOP + 5200],
    [0, 1, 1, 0]
  );
  const dCard1Y = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_DESKTOP + 2400, GOVERNANCE_TEXT_START_DESKTOP + 2800],
    [50, 0]
  );

  const dCard2Op = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_DESKTOP + 2600, GOVERNANCE_TEXT_START_DESKTOP + 3000, GOVERNANCE_TEXT_START_DESKTOP + 5000, GOVERNANCE_TEXT_START_DESKTOP + 5400],
    [0, 1, 1, 0]
  );
  const dCard2Y = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_DESKTOP + 2600, GOVERNANCE_TEXT_START_DESKTOP + 3000],
    [50, 0]
  );
  ...
  const mCard1Op = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_MOBILE + 2600, GOVERNANCE_TEXT_START_MOBILE + 2900, GOVERNANCE_TEXT_START_MOBILE + 4100, GOVERNANCE_TEXT_START_MOBILE + 4400],
    [0, 1, 1, 0]
  );
  const mCard1Y = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_MOBILE + 2600, GOVERNANCE_TEXT_START_MOBILE + 2900],
    [50, 0]
  );

  const mCard2Op = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_MOBILE + 4500, GOVERNANCE_TEXT_START_MOBILE + 4800, GOVERNANCE_TEXT_START_MOBILE + 6000, GOVERNANCE_TEXT_START_MOBILE + 6300],
    [0, 1, 1, 0]
  );
  const mCard2Y = useTransform(
    scrollY,
    [GOVERNANCE_TEXT_START_MOBILE + 4500, GOVERNANCE_TEXT_START_MOBILE + 4800],
    [50, 0]
  );
  ...
  return (
    <section
      id="governance"
      className="relative z-20 w-full h-[6800px] md:h-[5200px] pointer-events-none"
    >
